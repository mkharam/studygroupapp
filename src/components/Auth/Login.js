    ...
    <div className="min-h-screen bg-ios-gray6 flex flex-col justify-center px-4 py-12">
      <div className="max-w-md w-full mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-ios-large-title font-sf-pro mb-2 text-black">Welcome Back</h1>
          <p className="text-ios-subhead text-ios-gray">Sign in to continue to StudyGroupApp</p>
        </div>
          ...
          <form onSubmit={handleSubmit} aria-label="Login form">
            ...
            <div className="mb-6">
              <div className="flex justify-between">
                ...
                <Link to="/forgot-password" className="text-ios-blue text-ios-footnote">
                  Forgot password?
                </Link>
              </div>
              <input
                ...
                className={`ios-input w-full ${error && error.includes('Password') ? 'border-ios-red' : ''}`}
                placeholder="••••••••"
                disabled={loading}
        ...
        <div className="text-center">
          <p className="text-ios-subhead text-ios-gray">
            ...
            <Link to="/register" className="text-ios-blue">
              Sign Up
            </Link>
          </p>
        </div>
